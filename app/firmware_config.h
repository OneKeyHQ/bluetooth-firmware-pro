...
#define MANUFACTURER_ID                                                                                      \
    0x55AA55AA55 /**< DUMMY Manufacturer ID. Will be passed to Device Information Service. You shall use the \
                    ID for your Company*/
#define ORG_UNIQUE_ID                                                                                       \
    0xEEBBEE /**< DUMMY Organisation Unique ID. Will be passed to Device Information Service. You shall use \
                the Organisation Unique ID relevant for your Company */
